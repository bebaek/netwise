...
| Scenario | Baseline | First query-cache slice | Route-owned snapshots | Route-owned events | Route-owned asset real estate | Route-owned planning real estate | Reduction from baseline |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Initial authenticated workspace load | 50 | 46 | 44 | 42 | 36 | 32 | 36% |
| Change snapshot account filter | 18 | 1 | 1 | 1 | 1 | 1 | 94% |
| Toggle interpolated history | 24 | 1 | 1 | 1 | 1 | 1 | 96% |
| Save one household snapshot | 19 | 5 | 5 | 5 | 5 | 5 | 74% |
...
| Enter Planning and load route data | 6 | Account events, property sales, and liquidation strategies; each doubled by development Strict Mode |
...
- Entering Planning requests only account events, property sales, and liquidation strategies for its newly route-owned domains.
...
- Initial Overview loading does not issue per-account event requests and fetches neither snapshots, account events, properties, property analytics, mortgages, property sales, nor liquidation strategies.
