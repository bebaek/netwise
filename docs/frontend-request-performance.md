...
| Scenario | Baseline | First query-cache slice | Route-owned snapshots | Route-owned events | Route-owned asset real estate | Route-owned planning real estate | Route-owned budget data | Route-owned people data | Reduction from baseline |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Initial authenticated workspace load | 50 | 46 | 44 | 42 | 36 | 32 | 28 | 22 | 56% |
| Change snapshot account filter | 18 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | 94% |
| Toggle interpolated history | 24 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | 96% |
| Save one household snapshot | 19 | 5 | 5 | 5 | 5 | 5 | 5 | 5 | 74% |
...
| Enter Planning and load route data | 16 | Eight route collections; each doubled by development Strict Mode |
...
- Entering Planning requests only its eight route-owned collections.
